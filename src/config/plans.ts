...
export const PLANS: Record<Tier, PlanDef> = {
  ...
  STARTER: {
    tier: 'STARTER', slug: 'starter_39', name: 'Starter', priceMonthlyGBP: 39, publicVisible: true,
  ...
  GROWTH: {
    tier: 'GROWTH', slug: 'growth_99', name: 'Growth', priceMonthlyGBP: 99, recommended: true, publicVisible: true,
  ...
  PROFESSIONAL: {
    tier: 'PROFESSIONAL', slug: 'pro_199', name: 'Pro', priceMonthlyGBP: 199, publicVisible: true,
